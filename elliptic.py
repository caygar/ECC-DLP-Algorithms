"""
Implementation of an Elliptic Curve with the equation "y^2 = x^3 + ax + b" over a finite field.

It contains methods that:

-Check if a point is on the curve
-Calculate how many points are on the curve
-Calculate the order of a subgroup generated by a given point
-Create a new Point object on the curve
